...
//Runtime: 68 ms, faster than 83.26% of C++ online submissions for Binary Search Tree Iterator.
//Memory Usage: 28 MB, less than 10.86% of C++ online submissions for Binary Search Tree Iterator.
